...
INSERT INTO `author` VALUES (' silvia.marelli@gmail.com','Silvia','Marelli'),('campnari.stefano@gmail.com','Stefano','Campanari'),('christian123@google.com','Christian','Kehrer'),('dariocusati@yahoo.com','Dario','Cusati'),('joe.brad@gmail.com','Joseph','Bradley'),('joerntoelle676@ymail.com','Joern','Toelle');
...
CREATE TABLE `paper` (
  ...
  CONSTRAINT `paper_ibfk_1` FOREIGN KEY (`Author_Email`) REFERENCES `author` (`EmailAddr`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `review` VALUES (1,1,'bhatt.mitali@blackrock.com','N',7,5,6,4),(2,2,'johnsonmary567@yahoo.com','N',6,1,6,7),(3,3,'meena.meyer@gmail.com','Y',10,10,10,10),(4,4,'smithtrevor91@google.com','Y',8,6,10,9),(5,5,'vaibhav.seth@gmail.com','Y',9,8,6,7);
...
-- Dump completed on 2020-05-16 19:11:24
